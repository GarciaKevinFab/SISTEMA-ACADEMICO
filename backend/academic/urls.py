...
from .views.evaluation_pdf import (
    ...
    SectionActaCalificacionPdfView, EvaluationActasCalificacionSubsaPdfZipView,
...
urlpatterns = [
    ...
    path("sections/<int:section_id>/acta-calificacion.pdf",
         SectionActaCalificacionPdfView.as_view()),
