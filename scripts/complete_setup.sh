...
CORS_ORIGINS=http://localhost:3000,https://academic-treasury.preview.emergentagent.com
...
REACT_APP_BACKEND_URL=https://academic-treasury.preview.emergentagent.com/api
EOF
...
echo "• Frontend: https://academic-treasury.preview.emergentagent.com"
echo "• Backend API: https://academic-treasury.preview.emergentagent.com/api"
echo "• Health Check: https://academic-treasury.preview.emergentagent.com/api/health"
echo ""
