...
CORS_ORIGINS=http://localhost:3000,https://academic-admin-sys.preview.emergentagent.com
...
REACT_APP_BACKEND_URL=https://academic-admin-sys.preview.emergentagent.com/api
EOF
...
echo "• Frontend: https://academic-admin-sys.preview.emergentagent.com"
echo "• Backend API: https://academic-admin-sys.preview.emergentagent.com/api"
echo "• Health Check: https://academic-admin-sys.preview.emergentagent.com/api/health"
echo ""
