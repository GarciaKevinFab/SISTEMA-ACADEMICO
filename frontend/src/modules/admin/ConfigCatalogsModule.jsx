...
const ImportersTab = () => {
    ...
    return (
        <SectionCard icon={FileSpreadsheet} title="Importadores Excel / CSV" desc="Carga masiva de planes de estudio, alumnos, notas históricas y egresados">
                ...
                <div className="cfg-header rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                    <div className="px-6 py-5 flex items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div><h2 className="text-xl font-900 text-slate-800 tracking-tight">Configuración y Catálogos</h2><p className="text-xs text-slate-400 mt-0.5 font-500">Periodos, sedes, docentes, grados/títulos, importadores y respaldo</p></div>
                        </div>
